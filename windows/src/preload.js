...
contextBridge.exposeInMainWorld('jot', {
  ...
  onUpdateReady: callback => ipcRenderer.on('update:ready', (_event, value) => callback(value)),
  ...
  saveElevenLabsKey: (key) => ipcRenderer.invoke('elevenlabs-key:save', key),
  ...
  undoCancel: () => ipcRenderer.invoke('dictation:undo-cancel'),
  pasteLast: () => ipcRenderer.invoke('dictation:paste-last'),
  audioChunk: (data, sampleRate, id) => ipcRenderer.send('audio:chunk', { data, sampleRate, id }),
  audioStatus: (id,status)=>ipcRenderer.send('audio:status',{id,status}),
