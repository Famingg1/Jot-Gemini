...
class MeetingTranscriber {
  ...
  async process(id) {
    ...
    try {
      ...
      this.storage.saveMeta(id, { state: 'ready', error: null, retryCount: 0, nextRetryAt: null }); this.onProgress({ id, state: 'ready', completed: batches, total: batches });
